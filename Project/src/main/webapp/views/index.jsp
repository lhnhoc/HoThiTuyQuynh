          ...
          <ul class="navbar-nav">
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="course-details.jsp">Course Details</a>
              </div>
            </li>
            <li class="dropdown">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
      ...
      <div class="row justify-content-center fullscreen align-items-center">
        <div class="col-lg-5 col-md-8 home-banner-left">
          ...
          <p class="mx-auto text-white  mt-20 mb-40">
            The evolution of mathematics might notice a constantly increasing range of abstraction,
             or through the expansion of the content of study.
          </p>
        </div>
      ...
      <div class="feature-inner row">
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            <i class="ti-book"></i>
            <div class="ml-20">
              <h4>Answers and Questions</h4>
              <p>
                Search and exchange with each other the questions have answers easily.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            ...
            <div class="ml-20">
              <h4>Top Courses</h4>
              <p>
                Courses from basic to advanced easily absorb and selection
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex border-right-0">
            ...
            <div class="ml-20">
              <h4>Full E-Books</h4>
              <p>
                Textbook by grade, level divided by different levels.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="owl-carousel popuar-course-carusel">
        <div class="single-popular-course">
          ...
          <div class="details">
            ...
            <a href="#">
              <h4>Learn Math courses for elementary students</h4>
            </a>
        ...
        <div class="single-popular-course">
          ...
          <div class="details">
            ...
            <a href="#">
              <h4>Learn Math courses for high school students</h4>
            </a>
            <div class="bottom d-flex mt-15">
              <ul class="list">
                <li>
        ...
        <div class="single-popular-course">
          ...
          <div class="details">
            ...
            <a href="#">
              <h4>Learn Math courses for students in grades 10, 11, and 12</h4>
            </a>
            <div class="bottom d-flex mt-15">
              <ul class="list">
                <li>
        ...
        <div class="single-popular-course">
          ...
          <div class="details">
            ...
            <a href="#">
              <h4>Learn Math courses for college exam students</h4>
            </a>
            <div class="bottom d-flex mt-15">
              <ul class="list">
                <li>
        ...
        <div class="single-popular-course">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="img/avatar.jpg" alt="" />
          </div>
          <div class="details">
            ...
            <a href="#">
              <h4>Learn Math courses for college students</h4>
            </a>
            <div class="bottom d-flex mt-15">
              <ul class="list">
                <li>
      ...
      <div class="row align-items-end">
        ...
        <div class="offset-lg-3 col-lg-4 col-md-6">
          <div class="course-form-section">
            ...
            <form class="course-form-area contact-page-form course-form text-right" id="myForm" action="mail" method="post">
